...
int  XuLy_cell_row3(SudokuBoard *p_board,int row,int col,int i,int j)
{
    int count=0;
    int n_col=-1;
...
int  XuLy_cell_col3(SudokuBoard *p_board,int row,int col,int i,int j)
{
    int count=0;
    int n_row=-1;
    for (int n=0 ; n<9; n++)
...
int  XuLy_cell_box3(SudokuBoard *p_board,int row,int col,int i,int j)
{
